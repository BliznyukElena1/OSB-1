...
- [x] Печень является главным органом метаболизма аминокислот.  
...
2) синтез различных азотсодержащих небелковых соединений – пуринов, пиримидинов, мочевой кислоты, никотиновой кислоты, креатина и др.; 
3) синтез заменимых аминокислот; 
4) обеспечение через кровь других органов сбалансированной смесью аминокислот, необходимой для биосинтеза в них белков; 
5) перераспределение избыточных количеств потребленных с пищей аминокислот с использованием их углеродных цепей и азота. 
...
- [x] пищевых аминокислот, так и 
- [x] в результате распада тканевых белков, что является условием обновления последних. 
...
- [x] **экзопептидазы**, гидролизующие крайние пептидные связи с N- или С-конца полипептидной цепи, и 
- [x] **эндопептидазы**, гидролизующие внутренние полипептидные связи. 

В зависимости от каталитических особенностей активного центра различают:  
- [x] **тиоловые катепсины** (в каталитическом центре содержится **цистеин**), 
- [x] **аспарагиновые** или **карбоксикатепсины** (в каталитическом центре – **аспарагиновая кислота**) и 
- [x] **сериновые** (каталитический центр содержит **серин**). 
...
- [x] использование аминокислот для **биосинтеза** специфических для данного организма белков, 
- [x] превращение аминокислот до конечных продуктов с освобождением до 15% **энергии** метаболизма, 
- [x] специфические пути обмена отдельных аминокислот и их групп с образованием различных **биологически активных веществ** (биогенные амины, гормоны); 
- [x] использование продуктов обмена аминокислот (азотистых и безазотистых) для **биосинтеза** других соединений – **жирных кислот**, **кетоновых тел**, **глюкозы**. 
